                    ...
                    <div>
                        ...
                        <div style={{justifyContent: 'left', padding: 40 }}>
                            <h4 style={{color: "white"}}>
                                ...
                                operation and at the same time inspiring with design ideas. The web application will include a product sales section and a blog page to achieve its goals. Design ideas on the blog page will provide convenience to the user. The focus part of this 
                                project is on landscape design products so that people use this website to buy the landscape design products and easily decorate their own area with different ideas that comes from our website.
                            </h4>
                        </div>
                    </div>
                </div>
