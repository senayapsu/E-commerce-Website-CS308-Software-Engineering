...
const getProducts = async () => {
    ...
    const res = await axios.get("https://lapss-cs308.herokuapp.com/search?category=Garden");
...
const Products2 = (props) => // Produtcs var. is a fuction which does not take a parameter
{
