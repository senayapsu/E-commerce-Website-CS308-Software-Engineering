...
const getProducts = async () => {
    ...
    const res = await axios.get("https://lapss-cs308.herokuapp.com/designsearch?designcategory=design3");
...
const Products6 = (props) => // Produtcs var. is a fuction which does not take a parameter
{
