...
const getProducts = async () => {
    ...
    const res = await axios.get("https://lapss-cs308.herokuapp.com/designsearch?designcategory=design2");
...
const Products5 = (props) => // Produtcs var. is a fuction which does not take a parameter
{
